...
(function (global) {
  ...
  const STRINGS = {
    en: {
      ...
      'settings.account.usernameChecking': 'Checking availability…',
      'settings.account.usernameAvailable': 'Available — this username is yours to claim.',
      'settings.account.usernameTaken': 'That username is already taken.',
      'settings.account.usernameCurrent': 'This is your current username.',
      'settings.account.usernameInvalid': 'Invalid username.',
      'settings.session.title': 'Session',
      'settings.session.desc': 'Sign out of POXY WORLD on this device. You can sign back in anytime.',
    ...
    ru: {
      ...
      'settings.account.saved': 'Профиль сохранён!',
      'settings.account.usernameHint':
        'Ник уникален во всём POXY WORLD, как в X. Только буквы, цифры и подчёркивание.',
      'settings.account.usernameChecking': 'Проверяем доступность…',
      'settings.account.usernameAvailable': 'Свободен — можно занять.',
      'settings.account.usernameTaken': 'Этот ник уже занят.',
      'settings.account.usernameCurrent': 'Это ваш текущий ник.',
      'settings.account.usernameInvalid': 'Некорректный ник.',
      'settings.session.title': 'Сессия',
      'settings.session.desc': 'Выйти из POXY WORLD на этом устройстве. Можно войти снова в любой момент.',
      'settings.session.logout': 'Выйти',
